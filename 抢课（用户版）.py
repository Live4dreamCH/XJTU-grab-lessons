...
# 获取token
def get_token(my_cookies, my_id):
    url_gettoken = 'http://xkfw.xjtu.edu.cn/xsxkapp/sys/xsxkapp/student/register.do?number=' + my_id
    headers_1 = {
        'Cookie': my_cookies
    }
...
if __name__ == "__main__":  # 控制台界面部分
    ...
    cookies = get_cookie(my_id=student_ID, my_psw=Pass_word)

    headers = get_token(cookies, student_ID)
